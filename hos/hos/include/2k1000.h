...
static inline void ls64_conf_write64(u64 val64, volatile void  *addr)
{
...
static inline void ls64_conf_write32(u32 val, volatile void  *addr)
{
	asm volatile (
	"	.set push			\n"
	"	.set noreorder			\n"
...
static inline void ls64_conf_write16(u16 val, volatile void  *addr)
{
	asm volatile (
	"	.set push			\n"
	"	.set noreorder			\n"
...
static inline void ls64_conf_write8(u8 val, volatile void  *addr)
{
	asm volatile (
	"	.set push			\n"
	"	.set noreorder			\n"
...
#define writel(v, x) (*(volatile unsigned int *)(x) = (v))
